...
//! Uniquity finance customers plugin.
...
pub struct UniquityFinanceCustomerTag;

lariv_rs::define_passthrough_cap!(
    UniquityFinanceCustomerStateCap,
    UniquityFinanceCustomerTag,
    CustomerState
);
...
where
    ...
    L: HList + CapTagAbsent<UniquityFinanceCustomerTag, TagProof>,
{
    type Output = HCons<UniquityFinanceCustomerStateCap, L>;
