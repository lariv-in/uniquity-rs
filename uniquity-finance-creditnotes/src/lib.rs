...
//! Uniquity finance credit notes plugin.
...
pub struct UniquityFinanceCreditnotesTag;

lariv_rs::define_passthrough_cap!(
    UniquityFinanceCreditnotesStateCap,
    UniquityFinanceCreditnotesTag,
    CreditnotesState
);
...
where
    ...
    L: HList + CapTagAbsent<UniquityFinanceCreditnotesTag, TagProof>,
{
    type Output = HCons<UniquityFinanceCreditnotesStateCap, L>;
