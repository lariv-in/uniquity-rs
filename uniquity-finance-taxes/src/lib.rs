...
pub struct UniquityFinanceTaxesTag;

lariv_rs::define_passthrough_cap!(UniquityFinanceTaxesStateCap, UniquityFinanceTaxesTag, TaxesState);
...
where
    ...
    L: HList + CapTagAbsent<UniquityFinanceTaxesTag, TagProof>,
{
    type Output = HCons<UniquityFinanceTaxesStateCap, L>;
